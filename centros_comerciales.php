                ...
                <div id="mundo_aventura">
                    <div class="container">
                        <div class="card-deck">
                            ...
                            $consulta = "SELECT * FROM centros_comerciales WHERE localidad = '$localidad'";
                            $resultado = $conexion->query($consulta);


                            $consultaEstablecimientos = "SELECT * FROM registro_de_establecimiento WHERE Aprobado = 1 AND localidad = '$localidad' AND tipo_de_establecimiento = 'Centro_Comercial' ";
                            $resultadoEstablecimientos = $conexion->query($consultaEstablecimientos);
                            // Verifica si hay resultados
                            if ($resultado->num_rows > 0) {
                                // Almacena los resultados en un array
                                $centrosComerciales = $resultado->fetch_all(MYSQLI_ASSOC);
                                ...
                                foreach ($centrosComerciales as $centroComercial):
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            ...
                                            <?php
                                            $nombre_imagen = rawurlencode($centroComercial['nombre_imagen']);
                                            $imagenUrl = "./Imagenes/centros_comerciales/{$nombre_imagen}"; // Ajusta la extensión según el formato de tus imágenes
                                            ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <!-- Puedes agregar más detalles según tu estructura de base de datos -->
                                                <a href="resultado2.php?tabla=registro_de_establecimiento&id_establecimiento=<?php echo urlencode($EScentroComercial['Id_registro']); ?>"
                                                    class="btn btn-primary">Más información</a>
                                            </div>
                                        </div>
                                    </div>
