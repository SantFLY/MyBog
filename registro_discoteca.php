...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $carpeta_destino = 'Imagenes/discotecas/';
    if(!empty($archivos)) {
        ...
        foreach($archivos as $key => $archivo) {
            ...
            $nombre_archivo = $nombre_establecimiento.'.'.$extension;
    ...
    $sql = "INSERT INTO discotecas (Nombres_de_discotecas, Ubicacion_de_discotecas, Informacion_de_discotecas, Id_entretenimiento, localidad, nombre_imagen) 
        VALUES (?, ?, ?, ?, ?, ?)";

    $stmt = $conexion->prepare($sql);

    if($stmt) {
        $stmt->bind_param("sssiss", $nombre_establecimiento, $info_adicional, $informacion_adicional, $id_entretenimiento, $localidad, $nombre_archivo);
...
<body>
    <div class="wrapper">
        ...
        <div class="container">
            <h2>Registro de Discoteca</h2>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="login-box">
                        <form action="registro_discoteca.php" method="post" enctype="multipart/form-data">
                            <div class="form-group" name="nombre_establecimiento" id="nombre_establecimiento">
                                <label for="nombre_establecimiento">Nombre de la Discoteca</label>
                                <input type="text" class="form-control" name="nombre_establecimiento" maxlength="30"
                                pattern="[^;]*"
                                    title="Ingresa el nombre del establecimiento (máximo 30 caracteres, no se permite el caracter ';')" required>
                            </div>
                            ...
                            <div class="form-group" id="Direccion_de_establecimiento"
                                ...
                                <input type="text" class="form-control" name="info_adicional" maxlength="30" pattern="[^;]*"
                                    title="direccion (max 30 carácteres, no se permite el caracter ';')">
                            </div>
                    </div>
                    <div class="form-group" id="infoadd" name="infoadd">
                        <label for="informacion_adicional">Información Discoteca</label>
                        <textarea type="text" class="form-control" id="informacion_discoteca"
                            name="informacion_adicional" maxlength="250" pattern="[^;]*"
                            title="Ingresa la descripción que quieres darle a tu lugar (max 250 carácteres, no se permite el caracter ';')"
                            required></textarea>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="file" class="custom-file-input" id="photos" name="photos[]" accept="image/*"
    ...
    <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-delay="3000" style="display:none">
        ...
        <div class="toast-body">
            <?php
            echo "La discoteca ha sido registrada correctamente";
            ?>
        </div>
    </div>
