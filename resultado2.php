            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="detalle-establecimiento">
                        ...
                        if(isset($_GET['tabla']) && isset($_GET['id_establecimiento'])) {
                            $tabla = $_GET['tabla'];
                            $id_establecimiento = $_GET['id_establecimiento'];
                            $sqlImagen = "SELECT nombre_archivo FROM imagenes_establecimiento WHERE id_establecimiento = ?";
                            $stmtImagen = $conexion->prepare($sqlImagen);
                            $stmtImagen->bind_param("i", $id_establecimiento);
                            $stmtImagen->execute();
                            ...
                            if(in_array($tabla, $tablasPermitidas)) {
                                ...
                                switch($tabla) {
                                    ...
                                    case 'discotecas':
                                        ...
                                        break;
                                    case 'registro_de_establecimiento';
                                        $columnaNombre = 'Nombre_del_establecimiento';
                                        $columnaUbicacion = 'Direccion_de_establecimiento';
                                        $columnaInformacion = 'Informacion_adicional';
                                        break;
                                    default:
                                ...
                                $consulta = "SELECT * FROM $tabla WHERE id_registro = '$id_establecimiento'";
                                ...
                                if($resultado->num_rows > 0) {
                                    ...
                                    $nombre_archivo = $resultImagen->fetch_assoc()['nombre_archivo'];
                                    $imagenUrl = "Imagenes/$tabla/$nombre_archivo"; // Ajusta la ruta según tu estructura
