...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Get form data
    $nombre_centro_comercial = $_POST['nombre_centro_comercial'];
    $ubicacion_centro_comercial = $_POST['ubicacion_centro_comercial'];
    $informacion_centro_comercial = $_POST['informacion_centro_comercial'];
    $localidad = $_POST['localidad'];
    $id_entretenimiento = $_POST['id_entretenimiento'];

    $archivos = $_FILES['photos']['name'];
    $carpeta_destino = 'Imagenes/centros_comerciales/';
    if(!empty($archivos)) {
        ...
        foreach($archivos as $key => $archivo) {
            ...
            $nombre_archivo = $nombre_centro_comercial.'.'.$extension;
    ...
    $sql = "INSERT INTO centros_comerciales (Nombres_de_centros_comerciales, Ubicacion_de_centros_comerciales, Informacion_de_centros_comerciales, Id_entretenimiento, localidad, nombre_imagen) 
        VALUES (?, ?, ?, ?, ?, ?)";

    $stmt = $conexion->prepare($sql);

    if($stmt) {
        $stmt->bind_param("sssiss", $nombre_centro_comercial, $ubicacion_centro_comercial, $informacion_centro_comercial, $id_entretenimiento, $localidad, $nombre_archivo);
...
<body>
    <div class="wrapper">
        ...
        <div class="container">
            <h2>Registro de Centro Comercial</h2>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="login-box">
                        <form action="registro_centro_comercial.php" method="post" enctype="multipart/form-data">
                            <div class="form-group" id="nombre_centro_comercial">
                                <label for="nombre_centro_comercial">Nombre del Centro Comercial</label>
                                <input type="text" class="form-control" name="nombre_centro_comercial" maxlength="30"
                                    pattern="[^;]*"
                                    title="Ingresa el nombre del centro comercial (máximo 30 caracteres, no se permite el caracter ';')"
                                    required>
                            </div>

                            <div class="form-group" id="ubicacion_centro_comercial">
                                <label for="ubicacion_centro_comercial">Ubicación</label>
                                <input type="text" class="form-control" name="ubicacion_centro_comercial" maxlength="30"
                                    pattern="[^;]*"
                                    title="Ubicación (máximo 30 caracteres no se permite el caracter ';')">
                            </div>

                            <div class="form-group" id="informacion_centro_comercial">
                                <label for="informacion_centro_comercial">Información del Centro Comercial</label>
                                <textarea type="text" class="form-control" id="informacion_centro_comercial"
                                    name="informacion_centro_comercial" maxlength="250" pattern="[^;]*"
                                    title="Ingresa la descripción que quieres darle a tu centro comercial (máximo 250 caracteres no se permite el caracter ';')"
                                    required></textarea>
                            </div>
                            ...
                            <div class="form-group" id="localidad">
                                ...
                                <select class="form-control" id="localidad" name="localidad"
                                    title="Selecciona la localidad en la que se ubica tu centro comercial" required>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div id="image-preview" class="image-preview"
                                    title="Selecciona las imágenes de tu centro comercial que quieres mostrar."></div>
                            </div>
    ...
    <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-delay="3000" style="display:none">
        ...
        <div class="toast-body">
            <?php
            echo "El Centro Comercial ha sido registrado correctamente";
            ?>
        </div>
    </div>
